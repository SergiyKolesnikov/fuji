 ...
 * Keeps info about:
 * <ul>
 * <li>the accesses to implementations of a certain type, and</li>
 * <li>source file names and line numbers of accesses of a certain type</li>
 * </ul>
 * 
 * Used by ExtendedTypeCheck.jrag
 */
public class TypeErrorInfo {
    ...
    /*
     * is the access going to intern (unqualified access or this access or super
     * access)?
     */
    private boolean isUnqualifiedAccess;

    public TypeErrorInfo(SimpleSet decls, HashSet<String> accessSourceInfo,
            boolean isUnqualifiedAccess) {
        this.decls = decls;
