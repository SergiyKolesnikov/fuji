...
@MethodObject static class MediaController_showImage {
    ...
    void execute(){
      ...
      try {
        ...
        Display.getDisplay(_this.midlet).setCurrent(alert,Display.getDisplay(_this.midlet).getCurrent());
        return;
      }
      ...
      this.hook20();
      smscontroller=new SmsSenderController(_this.midlet,_this.getAlbumData(),(AlbumListScreen)_this.getAlbumListScreen(),name);
