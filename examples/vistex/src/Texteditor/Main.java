...
public   class  Main   extends javax.swing.JFrame {
	...
	// <editor-fold defaultstate="collapsed" desc="Generated Code">//GEN-BEGIN:initComponents
	  private void  initComponents__wrappee__Edieren  () {
	 ...
	 public void initComponents()  {
		 initComponents__wrappee__Edieren();
	...
	private void doTheLayout() {
	 ...
	 private void  doTheMenuBars__wrappee__Undo  () {
	  ...
	  private void  doTheMenuBars__wrappee__Formatierung  () {
	 ...
	 private void  doTheMenuBars__wrappee__Schriftgroesse  ()  {
		doTheMenuBars__wrappee__Formatierung();
	...
	private void doTheMenuBars()  {
	 ...
	 private void  initMenuBarItems__wrappee__Editor  () {
	  ...
	  private void  initMenuBarItems__wrappee__Undo  (){
	  ...
	  private void  initMenuBarItems__wrappee__Suchen  (){
		 initMenuBarItems__wrappee__Undo();
