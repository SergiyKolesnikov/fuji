...
public   class  Client  extends JFrame {
	...
	public Client(List<IMessageVisitor> inPlugins,
	 ...
	 private void  init__wrappee__authentication  () {
	...
	private void prepare_send(String text) {
	 ...
	 private void  cmd__wrappee__history  (String command, String... params) {
	 ...
	 private void  cmd__wrappee__colored  (String command, String... params) {
		...
		cmd__wrappee__history(command, params);
	}
	...
	private void cmd(String command, String... params) {
		...
		cmd__wrappee__colored(command, params);
	}
