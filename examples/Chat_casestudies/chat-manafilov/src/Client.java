...
abstract class Client$$Colors extends  Client$$Base  {
	public String color = "";
	...
	public void send(String line) {
		if(color.equals("")){
			...
			// HÃ¤ngt die Textfarbe an der String hinten an
	...
	public Client$$Colors ( String host, int port ) { super(host, port); }

}

abstract class Client$$Auth extends  Client$$Colors  {
	...
	public Client$$Auth ( String host, int port ) { super(host, port); }
...
abstract class Client$$Logs extends  Client$$Auth  {
	...
	public Client$$Logs ( String host, int port ) { super(host, port); }
