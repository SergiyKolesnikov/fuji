...
abstract class Connection$$Login extends  Connection$$Base  {
	...
	public Connection$$Login ( Socket s, Server server ) { super(s, server); }
}



abstract class Connection$$Reverse extends  Connection$$Login  {
