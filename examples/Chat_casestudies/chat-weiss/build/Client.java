...
abstract class Client$$Reverse extends  Client$$Base  
{
	...
	public void send(String from, String line, Color color) 
	{
		...
		super.send(from, line, color);
	}
      // inherited constructors



	public Client$$Reverse ( String host, int port,String name, StartingGui gui ) { super(host, port, name, gui); }
}
...
public class Client extends  Client$$Reverse  
{
	public void fireAddLine(String sender, String line, Color color) {
		...
		super.fireAddLine(sender, line,color);
	...
	public Client ( String host, int port,String name, StartingGui gui ) { super(host, port, name, gui); }
}