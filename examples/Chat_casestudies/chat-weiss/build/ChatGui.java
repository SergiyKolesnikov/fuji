 ...
 */
abstract class ChatGui$$Base extends JFrame implements ChatListener, ActionListener,
		WindowListener {
	 ...
	 */
	public ChatGui$$Base(String title, Client chatClient,String name) {
		super(title);
	...
	void addCom()
	{
		...
		inputField.addActionListener(((ChatGui) this));
...
public class ChatGui extends  ChatGui$$Base 
{
	...
	public void addCom()
	{
		...
		box.addActionListener(((ChatGui) this));
		panel.add(box);
	 ...
	 *            chatClient that is used for sending and receiving messages
	 */
	public ChatGui ( String title, Client chatClient,String name ) { super(title, chatClient, name); }
