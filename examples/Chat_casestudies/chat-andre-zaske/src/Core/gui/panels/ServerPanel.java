...
public   class  ServerPanel  extends AbstractTabPanel  implements ActionListener {
	...
	public ServerPanel(Gui g) {
	 ...
	 private void  init__wrappee__Ciphering  () {
		setName("Server");
	 ...
	 private void  init__wrappee__Rot13  () {
		init__wrappee__Ciphering();
		knowCiphers.put("Rot13",Rot13.class.getName());
	}

	
	private void init() {
		init__wrappee__Rot13();
		knowCiphers.put("AlphaBetaCipher",AlphaBetaCipher.class.getName());
	}
	...
	private void initView() {
		...
		// Ciphering
		// Handle Plugins
		String arrayString = "Keine Verschl�sselung";
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Serverport kann nicht ge�ffnet werden, "
