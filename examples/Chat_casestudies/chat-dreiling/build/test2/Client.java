 ...
 * simple chat client
 */
abstract class Client$$Core implements Runnable, ChatComponent {
	...
	public Client$$Core(String host, int port) {
		try {
			intialize(host, port);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void intialize(String host, int port) throws Exception {
			...
			((Client) this).outputStream = new ObjectOutputStream((socket.getOutputStream()));
			System.out.println("T2");
			((Client) this).inputStream = new ObjectInputStream((socket.getInputStream()));
...
abstract class Client$$GUI extends  Client$$Core  implements Runnable, ChatComponent {

	public void intialize(String host, int port) throws Exception {
		super.intialize(host, port);
...
public class Client extends  Client$$GUI  implements Runnable, ChatComponent {
