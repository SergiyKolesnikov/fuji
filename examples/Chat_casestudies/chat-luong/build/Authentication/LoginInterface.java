...
public class LoginInterface extends JFrame {
	...
	private void initialize() {
		((LoginInterface) this).setSize(248, 316);
		((LoginInterface) this).setContentPane(getJContentPane());
		((LoginInterface) this).setTitle("EPMDChat_Client");
		((LoginInterface) this).addWindowListener(new java.awt.event.WindowAdapter() {
