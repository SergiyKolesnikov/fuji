...
/**
 * Hilfsklasse fÃ¼r den Lucene-Index.
 * 
...
abstract class Indexer$$Base {
	...
	protected ArrayList contentHandlers = null;   ///< Liste aller verfÃ¼gbaren Content Handler
	 ...
	 * auch das erste (und einzige mal fÃ¼r diese Instanz) die Content Handler
	 * ermittelt.
	 * 
	 ...
	 * 
	 * Sucht nach dem fÃ¼r die Datei passenden ContentHandler und gibt ihn zurÃ¼ck.
	 * WÃ¼rden mehrere ContentHandler passen, so gibt er den zuerst gefundenen zurÃ¼ck.
	 * 
	 ...
	 * Suche durchfÃ¼hren.
	 * 
	 * Diese Methode fÃ¼hrt eine Suchanfrage Ã¼ber (falls nicht anders im Query angegeben)
	...
	/**
	 * Gibt die zuletzt verÃ¤nderten Dokumente zurÃ¼ck.
	 * 
	 * @param maxDocuments  maximale Trefferanzahl
	...
	/**
	 * Gibt die grÃ¶Ãten Dokumente zurÃ¼ck.
	 * 
	 * @param maxDocuments  maximale Trefferanzahl
	 * @return              IDs der grÃ¶Ãten Dokumente
	 */
	 ...
	 * 
	 * Diese Methode fÃ¼hrt schlussendlich die eigentliche Suchanfrage durch.
	 * DafÃ¼r verwendet sie die von den public Methoden erzeugten
	...
	protected TopDocs performQuery(Query query, Sort sorter, int max) {
		try {
			...
			// Wenn kein Sorter gewÃ¼nscht ist, darf auch keiner
			// Ã¼bergeben werden (nicht einmal null).
	...
	/**
	 * Gibt alle indexierten Felder zurÃ¼ck.
	 * 
	 * Diese Methode fragt jeden einzelnen ContentHandler nach den von ihm
	 * erstellten Feldern fÃ¼r seine Dokumente, um daraus die Menge aller
	 * verfÃ¼gbaren Felder zu ermitteln. In dieser werden dann Suchanfragen
	 * ausgefÃ¼hrt. Auf diese Weise muss bei der Suche nicht explizit das
	 * zu verwendende Feld angegeben werden und die Daten neuer ContentHandler
	 * sind sofort verfÃ¼gbar.
	 * 
	...
	/**
	 * Gibt ein Object[] zurÃ¼ck.
	 * 
	 * [0] beinhaltet das zu der ID passende Dokument zurÃ¼ck.
	...
	/**
	 * Gibt zurÃ¼ck, ob schon ein Index fÃ¼r den Ordner existiert. 
	 * 
	...
	public boolean exists() {
		...
		/**
	 * HÃ¤ufigkeit eines Termes berechnen.
	 * 
	 * Diese Methode berechnet aus dem Ã¼bergebenen TermFreqVector die Anzahl der
	 * Vorkommen des gesuchten Terms und gibt diesen zurÃ¼ck. Hierbei wird die
...
abstract class Indexer$$Multi_Directory extends  Indexer$$Base  {
	 ...
	 * Index erzeugen.
	 * 
	 * Schreibt den Index fÃ¼r das gegebene Verzeichnis. Dabei werden alle Dateien
	 * in allen (Unter-)verzeichnissen betrachtet und falls ein Content Handler
	 * fÃ¼r sie verfÃ¼gbar ist, auch indexiert.
	 * 
	 * @throws IndexerException  das angegebene Datenverzeichnis ist ungÃ¼ltig
	...
	public void createIndex(String[] dataDir) throws Exception {
		...
		// Als nÃ¤chstes holen wir uns einen IndexWriter von Lucene 
   ...
   ///< Liste aller verfÃ¼gbaren Content Handler
	 ...
	 * @param  luceneDir         Verzeichnis in dem der Index abgelegt wird
	 */
	public Indexer$$Multi_Directory ( String luceneDir )  throws IndexerException{ super(luceneDir); }
}
...
abstract class Indexer$$HTML extends  Indexer$$Multi_Directory  {
   ...
   ///< Liste aller verfÃ¼gbaren Content Handler
	 ...
	 * @param  luceneDir         Verzeichnis in dem der Index abgelegt wird
	 */
	public Indexer$$HTML ( String luceneDir )  throws IndexerException{ super(luceneDir); }
}
...
abstract class Indexer$$TXT extends  Indexer$$HTML  {
   ...
   ///< Liste aller verfÃ¼gbaren Content Handler
	 ...
	 * @param  luceneDir         Verzeichnis in dem der Index abgelegt wird
	 */
	public Indexer$$TXT ( String luceneDir )  throws IndexerException{ super(luceneDir); }
}
