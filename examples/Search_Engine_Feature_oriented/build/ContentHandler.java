...
/**
 * Basisklasse fÃ¼r ContentHandler.
 * 
 * Diese Klasse dient als gemeinsame Basis aller ContentHandler und
 * definiert ein paar Hilfsfunktionen, die fÃ¼r alle CH nÃ¼tzlich
 * sein kÃ¶nnten.
 * 
 * @author Mr. Pink
 */
public abstract class ContentHandler {
	...
	/**
	 * Standardfelder zum Dokument hinzufÃ¼gen.
	 * 
	 * In dieser Methode werden zu dem Ã¼bergebenen Dokument die Standardattribute hinzugefÃ¼gt.<br>
	 * Die Standardattribute sind: path, lastModify und size.
	 * 
	 * @param doc       Dokument zu dem die Attribute hinzugefÃ¼gt werden sollen
