...
//----------------------------------------------------------------------------
  ...
  private Dimension layoutSize(Container parentt,boolean minimum){
 
  Dimension dim=new Dimension(0,0);
  Dimension d;
  synchronized(parentt.getTreeLock()){
    int n=parentt.getComponentCount();
    for(int i=0;i<n;i++){
      Component c=parentt.getComponent(i);
      if(c.isVisible()){
  ...
  Insets insets=parentt.getInsets();
 ...
 */
   public void layoutContainer(Container parentt){
  Insets insets=parentt.getInsets();
  synchronized(parentt.getTreeLock()){
    int n=parentt.getComponentCount();
    Dimension pd=parentt.getSize(); int y=0;
...
//-----------------------------------------------------------------------------
   public Dimension minimumLayoutSize(Container parentt){return layoutSize(parentt,false);}
//-----------------------------------------------------------------------------
   public Dimension preferredLayoutSize(Container parentt){return layoutSize(parentt,false);}
//----------------------------------------------------------------------------
/**
