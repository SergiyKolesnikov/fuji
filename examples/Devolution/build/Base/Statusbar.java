...
public class Statusbar {
	...
	private void add ( JComponent component, Object constraints ) {
		...
		((Statusbar) this).pnStatusbar.add( component, constraints );
	}
	/**
	...
	public JComponent getComponent () {
		return ((Statusbar) this).pnStatusbar;
	}
	/**
	...
	public void addIcon ( final JComponent component ) {
		((Statusbar) this).pnIcons.add( component );
	}
	/**
	...
	public void removeIcon ( final JComponent component ) {
		((Statusbar) this).pnIcons.remove( component );
	}
	/**
	...
	public JProgressBar getProgressBar () {
		return ((Statusbar) this).progressBar;
	}
	/**
	...
	private void setLabel ( final JLabel label ) {
		if ( ((Statusbar) this).lbLabel != null ) {
			((Statusbar) this).pnStatusbar.remove( ((Statusbar) this).lbLabel );
		}
		add( label, BorderLayout.CENTER );
		((Statusbar) this).lbLabel = label;
	}
	/**
	...
	private void setProgressBar ( final JProgressBar progressBar ) {
		if ( ((Statusbar) this).progressBar != null ) {
			((Statusbar) this).pnStatusbar.remove( ((Statusbar) this).progressBar );
		}
		add( progressBar, BorderLayout.WEST );
		((Statusbar) this).progressBar = progressBar;
	}
	/**
	...
	public void modulToStatusbar( final Modul modul ) {
		...
		((Statusbar) this).pnStatusbar.repaint();
	}
}