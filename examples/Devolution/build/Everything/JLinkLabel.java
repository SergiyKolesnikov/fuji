package Everything;import java.awt.Desktop;
...
public class JLinkLabel extends JLabel implements MouseListener {
	...
	public void mouseClicked ( MouseEvent e ) {
		if ( ((JLinkLabel) this).uri != null ) {
			try {
				if ( ((JLinkLabel) this).uri.getScheme().equals( "mailto" ) ) {
					Desktop.getDesktop().mail( ((JLinkLabel) this).uri );
				} else if ( ((JLinkLabel) this).uri.getScheme().startsWith( "http" ) ) {
					Desktop.getDesktop().browse( ((JLinkLabel) this).uri );
				} else {
					System.err.println( ((JLinkLabel) this).uri + " is not supported" );
				}
	...
	public void setUri ( URI uri ) {
		((JLinkLabel) this).uri = uri;
		setText( ((JLinkLabel) this).text );
	}
	/* (non-Javadoc)
	 * @see javax.swing.JLabel#setText(java.lang.String)
	 */
	public void setText ( String text ) {
		((JLinkLabel) this).text = text;
		if ( ((JLinkLabel) this).uri == null ) {
			super.setText( text );
		} else {
			super.setText( String.format( "<html><body><a href=\"%s:%s\">%s</a></body></html>", ((JLinkLabel) this).uri.getScheme(), ((JLinkLabel) this).uri.getSchemeSpecificPart(), ((JLinkLabel) this).text ) );
		}
	}
	/* (non-Javadoc)
