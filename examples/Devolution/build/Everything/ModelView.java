...
public abstract class ModelView implements ActionListener, MultilingualListener {
	...
	protected void initView () {
		...
		((ModelView) this).btSidepanelButton.setText( ((ModelView) this).modul.getName() );
		((ModelView) this).btSidepanelButton.addActionListener( ((ModelView) this) );
		((ModelView) this).mnMenu.setText( ((ModelView) this).modul.getName() );
	}
	/**
	...
	public boolean isActive () {
		return ((ModelView) this).modul.base.getView().getActiveModul().equals( ((ModelView) this).modul );
	}
	/* +++ INITIALIZER +++ */
	/**
	...
	public JComponent getMainContent () {
		return ((ModelView) this).coContent;
	}
	/**
	...
	public PreferencesEntry getPreferences () {
		return ((ModelView) this).preferences;
	}
	/**
	...
	public JComponent getSidepanel () {
		return ((ModelView) this).coSidepanel;
	}
	/**
	...
	public JButton getSidepanelButton () {
		return ((ModelView) this).btSidepanelButton;
	}
	/**
	...
	public JLabel getStatusbarLabel () {
		return ((ModelView) this).lbStatusbar;
	}
	/**
	...
	public JProgressBar getStatusbarProgessBar () {
		return ((ModelView) this).pbStatusbar;
	}
	...
	public JToolBar getToolbar () {
		return ((ModelView) this).tbToolbar;
	}
	/*
	 * (non-Javadoc)
	 * 
	...
	public void actionPerformed ( ActionEvent event ) {
		...
		if ( ((ModelView) this).btSidepanelButton.equals( source ) ) {
			((ModelView) this).modul.getBase().getView().setActiveModul( ((ModelView) this).modul.getName() );
			((ModelView) this).modul.getBase().getView().validate();
		}
	}
}