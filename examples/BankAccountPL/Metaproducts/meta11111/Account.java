class Account {
	...
	//@ static invariant OVERDRAFT_LIMIT == (FeatureModel.overdraft ? -5000 : 0);

	/*@
	 @ requires OVERDRAFT_LIMIT == (FeatureModel.overdraft ? -5000 : 0); // KeY needs an invariant for method calls on this object to know which value is used because no compiler constant is used.
	 @ ensures balance == 0;
	 @*/
	Account() {
	}
	...
	final static int OVERDRAFT_LIMIT = FeatureModel.overdraft ? -5000 : 0;
	...
	/*@
	 @ requires FeatureModel.interestEstimation ==> daysLeft >= 0;
	 @ ensures FeatureModel.interestEstimation ==> \result == interest + daysLeft * calculateInterest();
	 @*/
